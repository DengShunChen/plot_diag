...
m = Basemap(llcrnrlon=110.,llcrnrlat=10.,urcrnrlon=140.,urcrnrlat=30., 
...
m.scatter(x,y,16,color='b',marker='o',edgecolors='none',zorder=20,label=platformname+' - '+str(nobs))
...
m.scatter(x,y,16,color=color,marker='o',edgecolors='none',zorder=20,label=platformname+' - '+str(nobs))
