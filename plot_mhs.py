...
instrument = 'mhs'
platformlist = ['n18','metop-a','metop-b','n19']
...
for platform in platformlist:
  ...
  if platform == 'n15':
    ...
    color='g'
    platformname='NOAA-18'
  elif platform == 'n19':
    color='c'
    platformname='NOAA-19'
  elif platform == 'metop-a':
    color='b'
    platformname='METOP-A'
...
plt.title(' %s   %s  Assimilated '% (dtg,'MHS'),fontsize=25)
